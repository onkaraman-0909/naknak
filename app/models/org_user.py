...
from .enums import OrgRoleEnum, OrgRole, StatusEnum, GenericStatus
...
class OrgUser(PKMixin, TimestampMixin, Base):
    ...
    role: Mapped[OrgRole] = mapped_column(OrgRoleEnum, default=OrgRole.corporate_user, nullable=False)
